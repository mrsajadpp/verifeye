...
from modules.checkurl import check_url_length, check_shortening_service, check_having_at_symbol, check_double_slash_redirecting, check_having_sub_domain, check_ssl_final_state, check_https_token_with_request, check_request_url
...
new_data_values = np.array([
    [domain, length, is_shorted, having_at_symbol, double_slash_redirecting, having_sub_domain, ssl_final_state, 1, -1, 1, https_token, request_url, 1, 0, -1, -1, 1, 1, 0, 1, 1, 1, 1, -1, -1, 0, -1, 1, 1, 1, -1]
